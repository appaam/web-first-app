...
/*
 * There is only one ServletContext object per Web application. The data stored
 * in this ServletContext object is global i.e. all the components(Servlets/JSPs) of 
 * this application can access the data.
 * 
 * To store/retrieve/remove data in ServletContext object
 *   setAttribute()
 *   getAttribute()
 *   removeAttribute()
 *   
 *   How did we initialize ServletContext object?
 *     In web.xml,using <context-param> tag
 *     
 *   To get initialization parameters of ServletContext object
 *    getInitParameter()
 */
/*
